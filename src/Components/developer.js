...
import Fetching from "../fetchPreload";
...
const Developer = () => {
  ...
  if (isFetchingJob) return <p><Fetching/></p>;
            ...
            <div className="job-image">
              ...
              <div className="job-desc">
                ...
                <span style={{ float: "right", marginRight: "5%" }}>
                  ...
                  {/* {(Date.now() - new Date(Jobs.created_at).getTime())/60/60} */}
                {" " + new Date(Date.now() - (new Date(Jobs.created_at).getTime() * 1000)).getHours()} Hour(s) ago
                </span>
